    ...
    */
    ...
    do
    {
      u8g2_SetFontDirection(&u8g2, 0);
        ...
        u8g2_SetFont(&u8g2, u8g2_font_unifont_t_gb2312);
      u8g2_DrawUTF8(&u8g2, x, y, "cn  骨 言 直");
        u8g2_SetFont(&u8g2, u8g2_font_unifont_t_japanese3);
      u8g2_DrawUTF8(&u8g2, x, y+20, "jp  骨 言 直");
