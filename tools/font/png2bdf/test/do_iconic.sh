...
../../bdfconv/bdfconv -f 1 -b 0 -m '64-255' -v open_iconic_${1}_1x.bdf -n open_iconic_${1}_1x -o open_iconic_${1}_1x.c -d ../../bdf/helvB12.bdf -g 8
...
../../bdfconv/bdfconv -f 1 -b 0 -m '64-255' -v open_iconic_${1}_2x.bdf -n open_iconic_${1}_2x -o open_iconic_${1}_2x.c -d ../../bdf/helvB12.bdf -g 8
...
../../bdfconv/bdfconv -f 1 -b 0 -m '64-255' -v open_iconic_${1}_4x.bdf -n open_iconic_${1}_4x -o open_iconic_${1}_4x.c -d ../../bdf/helvB12.bdf -g 8
...
../../bdfconv/bdfconv -f 1 -b 0 -m '64-255' -v open_iconic_${1}_6x.bdf -n open_iconic_${1}_6x -o open_iconic_${1}_6x.c -d ../../bdf/helvB12.bdf -g 8
...
../../bdfconv/bdfconv -f 1 -b 0 -m '64-255' -v open_iconic_${1}_8x.bdf -n open_iconic_${1}_8x -o open_iconic_${1}_8x.c -d ../../bdf/helvB12.bdf -g 8
